    ...
    torch.save(
        {
            ...
            "pose_graph_source": result.pose_graph.source.cpu(),
            "pose_graph_target": result.pose_graph.target.cpu(),
            "pose_graph_relative_poses": result.pose_graph.target_from_source.cpu(),
            "pose_graph_weights": result.pose_graph.weight.cpu(),
            "world_to_camera_mst": result.T_CWs_mst.cpu(),
            "rotation_averaged": result.Rs_avg.cpu(),
